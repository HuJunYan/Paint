 ...
 */
public class Model {
    public static List<StockBean> getData(Context context) {
        return new Gson(context).fromJson(data, StockListBean.class).getContent();
    }

    public static List<StockBean> getMoreData(Context context) {
        return new Gson(context).fromJson(moreData, StockListBean.class).getContent();
    }

    public static List<CandleEntry> getCandleEntries(Context context) {
        List<StockBean> rawData = getData(context);
        return getCandleEntries(rawData,0);
    }

    public static List<CandleEntry> getCandleEntries(List<StockBean> rawData, int startIndex) {
